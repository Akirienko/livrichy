...
<template>
	...
	<NuxtLink :to="data.full_slug!" class="card block mb-10 max-w-[570px]">
          <div class="h-60">
          ...
          <div class="px-4 pt-5 pb-6">
            ...
            <p class="mb-2 uppercase font-semibold text-2xl dots-text lg:max-w-[342px]">{{ data.name }}</p>
