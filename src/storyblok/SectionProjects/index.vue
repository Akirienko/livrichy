...
<template>
	<section class="section-projects">
		<!-- realty && !pending -->
		<div v-if="realty && !pending" class="container mx-auto px-6 xl:px-0">
			<h2 class="title w-full mb-8 text-palette-gradient_blue md:flex-row flex flex-col tablet:px-0">Latest <span class="tablet:ml-2 gold-title">Realty</span></h2>
			<div class="grid justify-center md:grid-cols-2 md:gap-8 lg:grid-cols-3">
